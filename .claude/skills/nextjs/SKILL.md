---
name: nextjs
description: Comprehensive Next.js v15+ skill for building modern web applications using the App Router, React Server Components, SSR/SSG/ISR data fetching, API routes, metadata/SEO, next/image optimization, and TypeScript. Use when scaffolding, building, or maintaining Next.js apps; when users mention Next.js 15+, App Router, Server Components, data fetching, MDX, middleware, SEO, or Next.js APIs.
...
ClaudeKit agents can use this Next.js Skill to:
...
### Authentication with Server Actions (`src/app/actions/auth.ts`)
```ts
'use server';
...
## Related Skills
- Tailwind CSS — Styling Next.js applications
...
## Key Takeaway
Next.js combines the best of server-side rendering, static generation, and client-side interactivity, making it the ideal choice for modern web applications. ClaudeKit agents leverage these capabilities to build fast, SEO-friendly, and maintainable applications.
